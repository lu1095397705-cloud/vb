...
var rule ={
    ...
    二级: {
        ...
        "lists": "#glist-1&&.scroll-content:eq(#id)&&a"//列表
      
      
    },
    搜索: '.module-items&&.module-search-item;.video-info-header&&a&&title;img&&data-src;.video-info-header&&a&&Text;.video-info-header&&a&&href',
